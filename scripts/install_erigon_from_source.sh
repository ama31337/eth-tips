...
# erigon install
cd ~/
wget https://github.com/ledgerwatch/erigon/archive/refs/tags/v${ERIGON_VER}.zip
unzip v${ERIGON_VER}.zip
rm v${ERIGON_VER}.zip
cd erigon-${ERIGON_VER}
make erigon
sudo cp ./build/bin/erigon /usr/local/bin/erigon
